...
Phase 1 controls include production timer constants, exact receiving-wallet claim authority, versioned Successor configuration, deterministic residual allocation to the final Successor, transaction rollback on policy failure, deposit-only pause, and registry disablement limited to new deposits.
